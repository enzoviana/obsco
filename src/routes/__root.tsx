...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium SaaS dashboard for pharmacy inventory management." },
      { name: "author", content: "PharmaOS" },
      { property: "og:title", content: "PharmaOS" },
      { property: "og:description", content: "Premium SaaS dashboard for pharmacy inventory management." },
