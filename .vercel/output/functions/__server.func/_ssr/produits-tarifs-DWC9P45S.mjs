...
import { P as setProductPricing, t as COUNTRIES, w as getProductPricing, x as getPanoramicProducts } from "./agencies-BIm1ZU-s.mjs";
import { c as require_jsx_runtime } from "../_libs/@radix-ui/react-arrow+[...].mjs";
import { t as Button } from "./button-DRsC1qZi.mjs";
import { _ as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { F as Download, I as Copy, N as FileSpreadsheet, _ as Save, d as Tag } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./AppShell-ClS6A7yg.mjs";
import { n as exportXLSX, t as exportCSV } from "./export-B7MgEGmo.mjs";
import { t as CountryToolbar } from "./produits-objectifs-EVLGnhDA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/produits-tarifs-DWC9P45S.js
...
function TarifsPage() {
	...
	const saveAll = () => {
		...
		for (const pid of dirty) {
			setProductPricing(pid, matrix[pid]);
			count++;
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, {
		...
		actions: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
				...
				size: "sm",
				onClick: () => {
					exportCSV("tarifs-produits", exportRows());
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
				...
				size: "sm",
				onClick: () => {
					exportXLSX("tarifs-produits", { Tarifs: exportRows() });
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryToolbar, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					style: { minWidth: 360 + visibleCountries.length * 110 },
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, { className: "h-3.5 w-3.5" }), "Produit"]
									})
								}),
								visibleCountries.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
						...
						filtered.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							colSpan: visibleCountries.length + 2,
