...
//#region node_modules/.nitro/vite/services/ssr/assets/produits-C9wEnGjI.js
...
function ImportDialog({ onClose }) {
	...
	const downloadTemplate = () => {
		const blob = new Blob(["nom,laboratoire,cip,type,prix\nParacétamol 500mg,LABORATOIRE X,3400936000001,Médicament,2.50\nIbuprofène 400mg,LABORATOIRE Y,3400938000002,Médicament,3.20"], { type: "text/csv;charset=utf-8;" });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
		className: "sm:max-w-2xl",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Importer des produits via CSV" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Téléchargez un fichier CSV contenant vos produits. Format attendu : nom, laboratoire, cip (optionnel), type (optionnel), prix (optionnel)." })] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							". Colonnes optionnelles : cip, type, prix"
						]
					})
