...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$36(_objectSpread$36({}, _objectWithoutProperties$17(_ref, _excluded$17)), {}, {
		type,
		size,
		sizeType
	});
...
var getPath$1 = function getPath(_ref) {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map(function(entry, index) {
			return _objectSpread$29(_objectSpread$29({}, entry), {}, { base: formatBaseLine[index] });
		});
...
var Curve = function Curve(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$26({}, filterProps(props, false), adaptEventHandlers(props), {
...
var Rectangle = function Rectangle(rectangleProps) {
	var props = _objectSpread$22(_objectSpread$22({}, defaultProps$3), rectangleProps);
...
var Trapezoid = function Trapezoid(props) {
	var trapezoidProps = _objectSpread$21(_objectSpread$21({}, defaultProps$2), props);
	var pathRef = (0, import_react.useRef)();
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$20({}, filterProps(trapezoidProps, true), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(es6_default, {
		...
		return /*#__PURE__*/ import_react.createElement(es6_default, {
			...
			duration: animationDuration,
			easing: animationEasing
		}, /*#__PURE__*/ import_react.createElement("path", _extends$20({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
var Sector = function Sector(sectorProps) {
	var props = _objectSpread$20(_objectSpread$20({}, defaultProps$1), sectorProps);
...
function Shape(_ref2) {
	var option = _ref2.option, shapeType = _ref2.shapeType, _ref2$propTransformer = _ref2.propTransformer, propTransformer = _ref2$propTransformer === void 0 ? defaultPropTransformer : _ref2$propTransformer, _ref2$activeClassName = _ref2.activeClassName, activeClassName = _ref2$activeClassName === void 0 ? "recharts-active-shape" : _ref2$activeClassName, isActive = _ref2.isActive, props = _objectWithoutProperties$10(_ref2, _excluded$10);
	var shape;
	if (/*#__PURE__*/ (0, import_react.isValidElement)(option)) shape = /*#__PURE__*/ (0, import_react.cloneElement)(option, _objectSpread$19(_objectSpread$19({}, props), getPropsFromShapeOption(option)));
...
var Pie = /*#__PURE__*/ function(_PureComponent) {
	function Pie(props) {
		...
		_defineProperty$21(_this, "pieRef", null);
		_defineProperty$21(_this, "sectorRefs", []);
		_defineProperty$21(_this, "id", uniqueId("recharts-pie-"));
		_defineProperty$21(_this, "handleAnimationEnd", function() {
			var onAnimationEnd = _this.props.onAnimationEnd;
			_this.setState({ isAnimationFinished: true });
			if ((0, import_isFunction.default)(onAnimationEnd)) onAnimationEnd();
		});
		_defineProperty$21(_this, "handleAnimationStart", function() {
	...
	return _createClass$15(Pie, [
		...
		},
		{
			...
			value: function renderLabels(sectors) {
				...
				var labels = sectors.map(function(entry, i) {
					...
					var labelProps = _objectSpread$18(_objectSpread$18(_objectSpread$18(_objectSpread$18({}, pieProps), entry), {}, { stroke: "none" }, customLabelProps), {}, {
						index: i,
						textAnchor: Pie.getTextAnchor(endPoint.x, entry.cx)
					}, endPoint);
					var lineProps = _objectSpread$18(_objectSpread$18(_objectSpread$18(_objectSpread$18({}, pieProps), entry), {}, {
						fill: "none",
						stroke: entry.fill
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var sectorProps = _objectSpread$18(_objectSpread$18({}, entry), {}, {
					...
					}, adaptEventsOfChild(_this2.props, entry, i), { key: "sector-".concat(entry === null || entry === void 0 ? void 0 : entry.startAngle, "-").concat(entry === null || entry === void 0 ? void 0 : entry.endAngle, "-").concat(entry.midAngle, "-").concat(i) }), /*#__PURE__*/ import_react.createElement(Shape, _extends$18({
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					sectors.forEach(function(entry, index) {
						...
						if (prev) {
							...
							var latest = _objectSpread$18(_objectSpread$18({}, entry), {}, {
							...
							var _latest = _objectSpread$18(_objectSpread$18({}, entry), {}, {
								startAngle: curAngle + paddingAngle,
		...
		},
		{
			...
			value: function renderLabelLineItem(option, props, key) {
				...
				return /*#__PURE__*/ import_react.createElement(Curve, _extends$18({}, props, {
					key,
					type: "linear",
					className
				}));
		...
		},
		{
			...
			value: function renderLabelItem(option, props, value) {
				...
				return /*#__PURE__*/ import_react.createElement(Text, _extends$18({}, props, {
...
_Pie = Pie;
_defineProperty$21(Pie, "displayName", "Pie");
_defineProperty$21(Pie, "defaultProps", {
	stroke: "#fff",
	fill: "#808080",
	legendType: "rect",
	cx: "50%",
...
_defineProperty$21(Pie, "parseDeltaAngle", function(startAngle, endAngle) {
	return mathSign(endAngle - startAngle) * Math.min(Math.abs(endAngle - startAngle), 360);
});
_defineProperty$21(Pie, "getRealPieData", function(itemProps) {
	...
	if (data && data.length) return data.map(function(entry, index) {
		return _objectSpread$18(_objectSpread$18(_objectSpread$18({ payload: entry }, presentationProps), entry), cells && cells[index] && cells[index].props);
	});
	if (cells && cells.length) return cells.map(function(cell) {
		return _objectSpread$18(_objectSpread$18({}, presentationProps), cell.props);
	});
	return [];
});
_defineProperty$21(Pie, "parseCoordinateOfPie", function(itemProps, offset) {
...
_defineProperty$21(Pie, "getComposedData", function(_ref4) {
	var item = _ref4.item, offset = _ref4.offset;
	var itemProps = item.type.defaultProps !== void 0 ? _objectSpread$18(_objectSpread$18({}, item.type.defaultProps), item.props) : item.props;
	...
	if (sum > 0) {
		...
		sectors = pieData.map(function(entry, i) {
			...
			prev = _objectSpread$18(_objectSpread$18(_objectSpread$18({
				percent,
				cornerRadius,
				name,
				tooltipPayload: [{
	...
	return _objectSpread$18(_objectSpread$18({}, coordinate), {}, {
		sectors,
		data: pieData
	});
});
...
var Bar = /*#__PURE__*/ function(_PureComponent) {
	function Bar() {
		...
		_defineProperty$19(_this, "id", uniqueId("recharts-bar-"));
...
_Bar = Bar;
_defineProperty$19(Bar, "displayName", "Bar");
_defineProperty$19(Bar, "defaultProps", {
	xAxisId: 0,
	yAxisId: 0,
	legendType: "rect",
	minPointSize: 0,
...
*/
_defineProperty$19(Bar, "getComposedData", function(_ref2) {
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		return _objectSpread$15(_objectSpread$15({}, result), {}, _defineProperty$18({}, id, finalAxis));
	}, {});
};
...
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$15(_objectSpread$15({}, res), {}, _defineProperty$18({}, key, ScaleHelper.create(options[key])));
	}, {});
...
_defineProperty$16(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty$16(CartesianAxis, "defaultProps", {
	x: 0,
	y: 0,
	width: 0,
	height: 0,
...
function CartesianGrid(props) {
	...
	if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction.default)(horizontalCoordinatesGenerator)) {
		...
		warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$15(generatorResult), "]"));
	...
	if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction.default)(verticalCoordinatesGenerator)) {
		...
		warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$15(_generatorResult), "]"));
	...
	return _createClass$11(Line, [
		...
		},
		{
			...
			value: function renderDots(needClip, clipDot, clipPathId) {
				...
				var dots = points.map(function(entry, i) {
					var dotProps = _objectSpread$11(_objectSpread$11(_objectSpread$11({
						key: "dot-".concat(i),
						r: 3
		...
		},
		{
			...
			value: function renderCurveStatically(points, needClip, clipPathId, props) {
				...
				_this$props3.ref;
				var curveProps = _objectSpread$11(_objectSpread$11(_objectSpread$11({}, filterProps(_objectWithoutProperties$5(_this$props3, _excluded$5), true)), {}, {
					fill: "none",
				...
				return /*#__PURE__*/ import_react.createElement(Curve, _extends$12({}, curveProps, { pathRef: this.pathRef }));
			}
		},
		{
		...
		},
		{
			...
			value: function renderDotItem(option, props) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
					...
					dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$12({ key }, dotProps, { className }));
				}
				return dotItem;
			}
		}
